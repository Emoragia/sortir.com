 ...
 */
final class Version20230816133345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE lieu SET ville_id=1');
        $this->addSql('ALTER TABLE lieu ADD CONSTRAINT FK_2F577D59A73F0036 FOREIGN KEY (ville_id) REFERENCES ville (id)');
        $this->addSql('CREATE INDEX IDX_2F577D59A73F0036 ON lieu (ville_id)');
        $this->addSql('ALTER TABLE sortie ADD site_organisateur_id INT NOT NULL, ADD lieu_id INT NOT NULL, ADD etat_id INT NOT NULL');
        $this->addSql('UPDATE sortie SET site_organisateur_id=1');
        $this->addSql('UPDATE sortie SET lieu_id=1');
        $this->addSql('UPDATE sortie SET etat_id=1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP site_organisateur_id, DROP lieu_id, DROP etat_id');
    }
}
