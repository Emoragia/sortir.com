...
final class Version20230814120032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD username VARCHAR(180) NOT NULL, ADD roles JSON NOT NULL, DROP pseudo, CHANGE id_participant id_participant INT AUTO_INCREMENT NOT NULL, CHANGE mot_passe password VARCHAR(255) NOT NULL, CHANGE mail email VARCHAR(80) NOT NULL');
